  ...
  render()
  {
    ...
    switch ( controlType ){
      case "checkbox":
        return (
          <Form.Group as={Row}>
            <Form.Label column sm="3">{ component.props.serialisedProperty.displayName }</Form.Label>
            <Col sm="9">
              <Form.Check
                ...
                onBlur={e => component.props.changeValue(component.props.serialisedProperty.id, e.target.checked.toString())}/>
            </Col>
          </Form.Group>);
      default:
        return (
          <Form.Group as={Row}>
            ...
            <Col sm="9">
              <Form.Control
                ...
                value={ component.state.value }
                onChange={e => component.setState({value: e.target.value}) }
                onBlur={e => component.props.changeValue(component.props.serialisedProperty.id, e.target.value)}
                type={controlType}
              />
            </Col>
          </Form.Group>);
